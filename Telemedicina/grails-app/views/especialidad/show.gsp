	...
	<body>
		...
		<div id="show-especialidad" class="content scaffold-show" role="main">
			...
			<ol class="property-list especialidad">
				...
				<g:if test="${especialidadInstance?.codigo}">
				<li class="fieldcontain">
					<span id="codigo-label" class="property-label"><g:message code="especialidad.codigo.label" default="Codigo" /></span>
					
						<span class="property-value" aria-labelledby="codigo-label"><g:fieldValue bean="${especialidadInstance}" field="codigo"/></span>
